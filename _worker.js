...
// Variables
const rootDomain = "cyantika.us.kg"; // Ganti dengan domain utama kalian
const serviceName = "nautika"; // Ganti dengan nama workers kalian
...
const zoneID = "8294821ec775dbb4162ee883decfebeb"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
